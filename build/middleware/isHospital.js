...
var NAMESPACE = "IsHospital";
var isHospital = function (req, res, next) {
    var _a;
    ...
    if (token) {
        jsonwebtoken_1.default.verify(token, config_1.default.server.token.secret, function (error, decoded) {
            ...
            else if ((decoded === null || decoded === void 0 ? void 0 : decoded.role) === roles_1.Roles.HOSPITAL) {
                res.locals.jwt = decoded;
                next();
            }
            else {
                return (0, makeResponse_1.default)(res, 404, "Only Hospital Admins can perform this task", null, true);
            }
        });
    }
    else {
