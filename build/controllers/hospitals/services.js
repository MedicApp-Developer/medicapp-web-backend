...
var createService = function (req, res, next) {
    var _a = req.body, name_en = _a.name_en, name_ar = _a.name_ar;
    var newServices = new services_1.default({ name_en: name_en, name_ar: name_ar });
...
var deleteService = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, services_1.default.findByIdAndDelete(_id)];
            case 2:
                services = _a.sent();
                if (!services)
