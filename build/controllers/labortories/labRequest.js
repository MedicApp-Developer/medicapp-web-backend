...
var NAMESPACE = "Labortory Request";
var createLabRequest = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, appointmentId, doctorId, patientId, laboratoryId, tests, newlabRequest;
    return __generator(this, function (_b) {
        _a = req.body, appointmentId = _a.appointmentId, doctorId = _a.doctorId, patientId = _a.patientId, laboratoryId = _a.laboratoryId, tests = _a.tests;
...
var getLabRequests = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var page, status, role, total_1, total_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!(role === roles_1.Roles.LABORTORY)) return [3 /*break*/, 2];
                return [4 /*yield*/, labRequest_1.default.find({ laboratoryId: res.locals.jwt.reference_id, status: status }).countDocuments({})];
            case 1:
                total_1 = _a.sent();
                // @ts-ignore
...
var updateLabRequest = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var labRequest, filter, update;
    return __generator(this, function (_a) {
        labRequest = req.params.labRequest;
