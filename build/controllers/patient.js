                            ...
                            _user.save().then(function (createdUser) {
                                ...
                                (0, signJWT_1.default)(createdUser, function (_error, token) {
                                    if (_error) {
                                        ...
                                        console.log(path_1.default.join(("".concat(__dirname))));
                                        var content = fs_1.default.readFileSync(path_1.default.join(("".concat(__dirname, "/../templates/RegisterationEmail.html"))));
                                        var final_template = content.toString().replace('[name]', firstName + " " + lastName).toString().replace('[username]', email).toString().replace('[password]', password);
                                        var options = {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                filter = { _id: id };
                // @ts-ignore
                patient_1.default.findOneAndUpdate(filter, { image: result.url }, { new: true }).then(function (updatedPatient) {
