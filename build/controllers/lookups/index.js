...
var insertLookups = function () { return __awaiter(void 0, void 0, void 0, function () {
    var options;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, mongoose_1.default.connect(MONGO.url, MONGO.options)];
            case 1:
                _a.sent();
                console.log("Clearing the lookups first...");
                return [4 /*yield*/, gender_1.default.deleteMany({})];
            case 2:
                _a.sent();
                return [4 /*yield*/, country_1.default.deleteMany({})];
            case 3:
                _a.sent();
                return [4 /*yield*/, language_1.default.deleteMany({})];
            case 4:
                _a.sent();
                console.log("Inserting lookups");
                options = { ordered: true };
                return [4 /*yield*/, gender_1.default.insertMany(gender, options)
                    //@ts-ignore
                ];
            case 5:
                _a.sent();
                ...
                return [4 /*yield*/, country_1.default.insertMany(countryList, options)
                    //@ts-ignore
                ];
            case 6:
                _a.sent();
                ...
                return [4 /*yield*/, language_1.default.insertMany(languagesList, options)
                    //@ts-ignore
                ];
            case 7:
                _a.sent();
