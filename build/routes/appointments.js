...
router.get('/doctorApprovedAppointments/:doctorId', isHospitalOrDoctor_1.default, appointments_1.default.getDoctorApprovedAppointments);
router.get('/hospitalBooked/:hospitalId', extractJWT_1.default, appointments_1.default.getAllHospitalBookedAppointments);
router.get('/approvePatientAppointment/:slotId/:patientId', extractJWT_1.default, appointments_1.default.approvePatientAppointment);
